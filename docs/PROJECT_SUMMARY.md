...
**5.2 Team Roles
      1. **Project Manager**: Fabilous Lashidi
      2. **System Architect**: Zvinaishe Marume
      3. **UI Designer**: Promise Siafwiyo
      4. **UX Designer**: Tapiwa Chigome
      5. **Researcher**: Keith Mutabvuri
      6.  **Frontend Developer**: Carlton Kampota
      7.  **Documentation Specialist**: Tivonge Kambarani
      8. **System Analyst**: Tinotenda Gozi
      9. **Quality Assurance**: Gufe Makomborero
...
7.1 Challenges Faced
   ...
   2. **User Experience**: Making complex processes simple
      - *Solution*: Intuitive navigation, clear status indicators
...
**Team**: Software Engineering Course - Group Project
